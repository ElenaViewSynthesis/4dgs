...
Number of points at initialisation :  38569

python train.py -s  data/hypernerf/virg/broom2/ --port 6017 --expname "hypernerf/virg/broom2" --configs arguments/hypernerf/broom2.py 
python train.py -s  data/hypernerf/virg/broom2/ --port 6017 --expname "hypernerf/virg/broom2" --configs arguments/hypernerf/broom2.py 
python render.py --model_path "output/hypernerf/broom2/"  --skip_train --configs arguments/hypernerf/broom2.py


https://github.com/fudan-zvg/4d-gaussian-splatting/blob/main/configs/dynerf/coffee_martini.yaml
"""
import numpy as np
import random
import os, sys
...
if __name__ == "__main__":
    ...
    setup_seed(6666)
    lp = ModelParams(parser)                                                    #Loooooooooooooooooooooooooooooooooooooo
    op = OptimizationParams(parser)                                             #oooooooooooooooooooooooooooooooooooooo
    pp = PipelineParams(parser)                                                 #iiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii
    hp = ModelHiddenParams(parser)                                              #iiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii
    ...
    torch.autograd.set_detect_anomaly(args.detect_anomaly)               #BELOW
